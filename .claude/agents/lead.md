...
tools: ["Read", "Glob", "Grep", "Bash", "Edit", "Write", "Agent(explorer, planner, implementer, tester, reviewer, security)", "AskUserQuestion"]
---
...
Use this lead as the main session with `claude --agent lead`; a nested
Claude subagent cannot orchestrate further subagents.
